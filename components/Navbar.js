          ...
          <div className="mx-auto max-w-7xl px-4 lg:px-6 lg:px-8 h-16">
            <div className="flex items-center h-16 justify-between lg:justify-end">
              ...
              <div className="flex lg:hidden">
                <Disclosure.Button className="relative h-10 w-10 inline-flex items-center justify-center rounded-sm text-pirateGold-500 hover:bg-shark-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-pirateGold-500">
