export default function Address() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-8 shadow-2xl sm:px-24 xl:pt-18 xl:pb-24">
      ...
      <div className="w-11/12 max-w-7xl my-8 mx-auto px-4 lg:px-6">
