...
export default function ProductForm({ categories, product = undefined }) {
  ...
  return (
    <form
      className="space-y-8 divide-y divide-shark-900 p-8"
      onSubmit={onSubmit}
    >
      <div className="space-y-8 divide-y divide-shark-900 sm:space-y-5">
        <div className="space-y-6 sm:space-y-5">
          <div>
            <h3 className="text-lg font-medium leading-6 text-pirateGold-200">
          ...
          <div className="space-y-6 sm:space-y-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                ...
                >
                  <div className="space-y-1 text-center">
                    ...
                    <div className="flex text-sm text-pirateGold-600">
                      <label
                        htmlFor="file-upload"
                        className="relative cursor-pointer rounded-md bg-pirateGold-900 font-medium text-pirateGold-200 focus-within:outline-none focus-within:ring-2 focus-within:ring-pirateGold-500 focus-within:ring-offset-2 hover:text-pirateGold-500"
                      >
                        <span>
                          {image !== ""
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-shark-800 sm:pt-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                <textarea
                  className="block w-full border-2 rounded-md text-pirateGold-200 h-20 bg-shark-950 border-shark-800"
                  type="text"
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-shark-800 sm:pt-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                <textarea
                  className="block w-full border-2 rounded-md text-pirateGold-200 h-36 bg-shark-950 border-shark-800"
                  type="text"
